...
export const metadata: Metadata = {
  title: "Hair Center of Turkey — Concept Redesign",
  description:
    "An unofficial concept redesign for Hair Center of Turkey by Alperen Muti. Surgeon-led FUE & DHI hair restoration in Istanbul.",
};
